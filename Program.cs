...
var connectionString = builder.Configuration.GetConnectionString("tennisContextConnection")
    ?? throw new InvalidOperationException("Connection string 'tennisContextConnection' not found.");
...
static async Task InitializeRolesAndAdminAsync(IServiceProvider services)
{
    ...
    var adminEmail = "admin@anyonefortennis.com";
    ...
    if (adminUser == null)
    {
        ...
        var createUserResult = await userManager.CreateAsync(adminUser, "adminAFT@2024");
